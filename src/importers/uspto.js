  ...
  return validateSource({
    ...
    metadata: {
      ...
      sourceUrl:
        "https://www.uspto.gov/trademarks/apply/check-status-view-documents/trademark-bulk-data",
      notes:
        "Derived structural review subset from imported USPTO standard-character trademarks and service marks. Trailing legal-entity suffixes are stripped to the filter-facing brand term before structural thresholding. The maintained default keeps one-word marks with at least 5 characters, keeps at most two-word marks with at least 6 characters per token, and drops digit-bearing terms.",
    },
    rules: filteredRules,
  });
}
